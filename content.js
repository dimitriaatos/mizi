...
"The combination of the analog shortwave with the newer technology of SDR forms a unique, amalgamated medium with mixed properties. “Radio Crawler” probes the high frequency band revealing ham radio transmissions, Morse codes, NAVTEX, encrypted messages, commercial radio, jammers, and time-signals, among many other unique transmissions."
...
},
  {
    ...
    },
    {
        ...
        description: ["Rummaging through some broken records and CDs, using my Augmented Turntable Max/MSP system alongside a Pioneer CDJ.",
        ...
        },
        {
            ...
            documentation: {video: "https://www.youtube.com/watch?v=u1uWfg5cTUk&list=PL9LzXXuboQl1LHVGc7BRaNM7zSmrMMiCG&index=1"},
            description: ["Buzzer was commissioned by Onassis Stegi from the young composer Niki Krasaki. A rich palette of sounds drawn from toys, and from children’s musical instruments and objects, acted as the source of her inspiration, unleashing her imagination for the creation of a unique form of music notation that allows for improvisation. The piece is performed by Trigger Happy, an edgy four-piece improvisational contemporary music collective who play (with) phrases from well-known children’s melodies and fables, and with the rules of team games.",
            ...
            },
            {
              ...
              description: [`LOW BIT RATE STREAMING is a web-based audiovisual performance that took place on the facebook platform 31 march of 2020 during the COVID-19 Greek state lockdown.", 
                ...
                description: ["Ancient Future Solo was a choreography-sound workshop that spanned for 9 sessions. Adolescents aged 14 to 17, were called to explore and create a solo dance piece. Antigone and Helen were chosen as a starting conceptual point, from there on, each participant, through guidance, made their own artistic decisions, composing a short sol dance piece. The music was made in collaboration with each participant, discussing, the form, sounds, textures and density that’d better corresponded to their piece. The 8 dance works were documented as video-dance performances due to COVID-restrictions. The temporary lift of the restrictions at the summer of 2021 lead to a live-performance, where all the participants worked intensively as a dance group creating a new piece, longer in form, and presenting it in-front of a live audience on September 2021."]
                },
                  {
                      ...
                      },
                      {
                          ...
                          description: ["A deep scan of the youtube sphere. Hidden gems and rare finds re-composed. A number of untitled videos, pronunciation videos, high school choir practices, accidental uploads and compression algorithm tests has been meticulously collected, edited and rearranged, resulting in an hour long “deep internet music” radio piece.",
                          ...
                          },
                          {
                              ...
                              medium: "Workshop for turntables, prepared records, cut-up records, various material",
                              documentation: {Link: "https://youtu.be/GrHAE0R--lM"},
                              description: ["For the duration of the workshop the participants were called to experiment with the turntable and various records, cutting them up, preparing them, creating new surfaces and exploring new ways of interacting with the medium, ultimately turning it into a musical instrument.",
                                ...
                                },
                            {
                                ...
                                documentation: {Link: "https://mizithras.bandcamp.com/album/keeping-pace"},
                                description: ["A collection of acousmatic music pieces created in the span of 2 years.",
...
},
{
  ...
  medium: " G. Kokkinaris: double-bass MIZI: 0-input mixer, portable cassette players, 4-track cassette recorders, electromagnetic coils, contact microphones, toy flutes",
  documentation: {Link: "https://kohma.bandcamp.com/album/kohma-live-at-chimeres-space"},
  description: ["The album is the debut release of the free improvisation duet KOHMA. As an introduction to the intuitive music of KOHMA, we've released a live set that took part at chimeres.space on 1st of December 2018 and captures the unadulterated essence of our sound. The B-side is split between solo pieces of KOHMA members: Four studies of electronic and electroacoustic music by MIZI and an improvisational piece revolving around the tragic murder of Mary Rose."]
  },
  {
    category: "Web/Radio Sound Art",
    ...
    documentation: {Link: "https://kohma.bandcamp.com/album/kohma-live-at-chimeres-space"},
    description: [`The station is an online program that procedurally generates sonic output by receiving combined weather data from a physical weather station in Greece.`,
